...
from .loss_models import MLMLossModel
from .metrics import mlm_accuracy, nsp_accuracy, classification_accuracy
from .datasets.bart_infilling import InfillingDataset
...
def pretrain_bart_infilling(data_dir, train_path, val_path, dictionary_path,
    ...
    train_dataset = InfillingDataset(data_path=train_path, dictionary=dictionary, dataset_limit=dataset_limit, rate=3)
    val_dataset = InfillingDataset(data_path=val_path, dictionary=dictionary, dataset_limit=dataset_limit, rate=3)
